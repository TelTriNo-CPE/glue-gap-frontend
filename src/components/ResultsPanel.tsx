...
export default function ResultsPanel({ width = 320, result, gaps, error, hiddenGapIndices, onShowAllGaps, onHideAllGaps, onToggleGap, selectedGapIds, onSelectGap, isSyncViewport, onToggleSyncViewport, visibleGapIdsInViewport, detectionHistory, activeVersionId, onSwitchVersion, onDeleteVersion }: Props) {
  ...
  return (
    <aside 
      className="bg-white border-l border-gray-200 flex flex-col h-full overflow-hidden shrink-0"
    ...
    >
      ...
      {gaps.length > 0 ? (
        ...
        <div className="flex-1 w-full bg-white flex flex-col items-center justify-center text-center p-4">
          {error ? (
            ...
            <>
              <svg className="w-16 h-16 text-gray-200 mb-6" fill="none" viewBox="0 0 24 24"
